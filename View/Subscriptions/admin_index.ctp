				...
				<td class="actions">
					<?php
						...
						if(($subscription['Event']['free'] || $subscription['Payment']['confirmed']) && !$subscription['Subscription']['checked'])
							echo $this->Html->glyphLink(__('Check-in'), array('controller' => 'subscriptions', 'action' => 'checkin', $subscription['Subscription']['id']), array('glyph' => 'glyph-check glyph-large'));

						echo $this->Html->glyphLink(__('Ver'), array('action' => 'view', $subscription['Subscription']['id']), array('glyph' => 'glyph-file glyph-large')),
							$this->Html->glyphLink(__('Alterar'), array('action' => 'edit', $subscription['Subscription']['id']), array('glyph' => 'glyph-edit glyph-large')),
							$this->Html->glyphLink(__('Remover'), array('action' => 'delete', $subscription['Subscription']['id']), array('glyph' => 'glyph-trash glyph-large'), sprintf(__('Deseja realmente excluir a inscrição #%s?'), $subscription['Subscription']['id']));
					?>
				</td>
			</tr>
		<?php endforeach; ?>
