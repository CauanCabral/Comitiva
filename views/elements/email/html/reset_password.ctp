...
<br />
Para dar prosseguimento a recuperação da senha, acesse o endereço: <a href="http://comitiva.phpms.org/reset_password/<?php echo $token; ?>">http://comitiva.phpms.org/reset_password/<?php echo $token; ?></a>.
<br />
