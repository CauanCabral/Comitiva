...
<br />
Para confirmar a criação da conta, acesse o link: <a href="<?php echo $html->link(array('controller' => 'users', 'action' => 'account_confirm', $token.'/'.$user['User']['username'])); ?>"><?php echo $html->link(array('controller' => 'users', 'action' => 'account_confirm', $token)); ?></a>.
<br />
